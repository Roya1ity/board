...
public class FileStorageService {
    ...
    public void init() {
        try {
            ...
            log.debug("파일 업로드 디렉토리 생성됨: {}",uploadPath);
        }
        catch (IOException e) {
            throw new BusinessException(ErrorCode.INVALID_FILE_UPLOADDIR);
        }
    }
    ...
    public String store(MultipartFile file) {
        ...
        try(InputStream in = file.getInputStream()) {
            ...
            log.error("파일 복사 에러: 파일명({}) {}",storedName,e.getMessage());
            throw new BusinessException(ErrorCode.INVALID_FILE_TYPE);
        }
    ...
    public void delete(String fileName) {
        ...
        try {
            ...
            log.error("파일 삭제중 에러가 발생함: {}",e.getMessage());
        }
    }
